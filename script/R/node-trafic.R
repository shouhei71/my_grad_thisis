...
plot(number,y,ylim = c(0,ylimit),xlim=c(0,320),yaxt="n",main=graph_title,ylab=ylab,xlab=xlab,cex.lab  = 1.8,cex.main = 1.2,cex.axis=1.8,pch=1,cex = 2.0)

axis(2,at=c(0,5000000,10000000,15000000,20000000,25000000,30000000),labels=c("0","5","10","15","20","25","30"),cex.axis=1.7)

par(new=T)
curve(224.6 * (x^2) + 4314.8 * x,ylim = c(0,ylimit),xlim=c(0,320), yaxt="n",main=graph_title,xlab=xlab,ylab=ylab,cex.lab= 1.8,cex.main = 1.2,cex.axis=1.8,col="red")
